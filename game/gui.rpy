...
init python:
    ...
    ## config.font_replacement_map maps bold and italics to the given files
    ## instead of the autogenerated ones from Ren'py    
    ...
    config.font_replacement_map["Arsenal-Regular.ttf", True, False] = ["Arsenal-Bold.ttf", False, False]
    config.font_replacement_map["Arsenal-Regular.ttf", False, True] = ["Arsenal-Italic.ttf", False, False]
    config.font_replacement_map["Arsenal-Regular.ttf", True, True] = ["Arsenal-BoldItalic.ttf", False, False]
    ...
    config.ftfont_vertical_extent_scale["fonts/header/Arsenal-Bold.ttf"] = .8
    config.ftfont_vertical_extent_scale["fonts/header/Arsenal-BoldItalic.ttf"] = .8
    config.ftfont_vertical_extent_scale["fonts/header/Arsenal-Italic.ttf"] = .8
    config.ftfont_vertical_extent_scale["fonts/header/Arsenal-Regular.ttf"] = .8
    ...
    config.ftfont_vertical_extent_scale["fonts/typewriter/CourierPrime-Bold.ttf"] = 1
    config.ftfont_vertical_extent_scale["fonts/typewriter/CourierPrime-BoldItalic.ttf"] = 1
    config.ftfont_vertical_extent_scale["fonts/typewriter/CourierPrime-Italic.ttf"] = 1
    config.ftfont_vertical_extent_scale["fonts/typewriter/CourierPrime-Regular.ttf"] = 1
    ...
    config.font_replacement_map["LeagueSpartan-Regular.otf", True, False] = ["LeagueSpartan-Semibold.otf", False, False]
    ...
    config.ftfont_vertical_extent_scale["fonts/dialogue/LeagueSpartan-Bold.otf"] = 1
    config.ftfont_vertical_extent_scale["fonts/dialogue/LeagueSpartan-Medium.otf"] = 1
    config.ftfont_vertical_extent_scale["fonts/dialogue/LeagueSpartan-Regular.otf"] = 1
    config.ftfont_vertical_extent_scale["fonts/dialogue/LeagueSpartan-Semibold.otf"] = 1
    ...
    config.font_replacement_map["SS Soapy Hands Regular.otf", True, False] = ["SS Soapy Hands Bold.otf", False, False]
    config.font_replacement_map["SS Soapy Hands Regular.otf", False, True] = ["SS Soapy Hands Italic.otf", False, False]
    config.font_replacement_map["SS Soapy Hands Regular.otf", True, True] = ["SS Soapy Hands Bold Italic.otf", False, False]
...
################################################################################
## Brightness / Contrast preferences
################################################################################
init python:
    import functools
...
define config.after_default_callbacks += [
    functools.partial(renpy.show_layer_at, [layer_color], "screens", camera=True),
...
define gui.name_color = gui.preference("name_color", '#fff') 

## The colors used for dialogue and menu choice text.
define gui.text_color = gui.preference("text_color", '#000') # darkmode: '#fff'
# define gui.interface_text_color = '#404040'

## An accent color used throughout the interface to label and highlight text.
define gui.accent_color = gui.preference("accent_color", '#900') #darkmode: '#90CAF9'

## The color used for a text button when it is neither selected nor hovered.
define gui.idle_color = gui.preference("idle_color", '#555')  # darkmode: '#bbb'
...
define gui.dark_mode = gui.preference("dark_mode", False)
...
define gui.choice_special_icon_size = 66

define gui.choice_button_width = 1185
define gui.choice_button_height = None
define gui.choice_button_tile = False
define gui.choice_button_borders = Borders(175, 25, 175, 25)
